...
define( 'rvc',[ 'ractive' ], function( Ractive ) {
...
(function ( global, factory ) {
	...
	// AMD?
		...
		define('vendor/ractive-transitions-slide/ractive-transitions-slide',[ 'ractive' ], factory );
	}
...
(function ( global, factory ) {
	...
	// AMD?
		...
		define('vendor/ractive-transitions-fly/ractive-transitions-fly',[ 'ractive' ], factory );
	}
...
define("rvc!components/helloworld",["require","ractive","rvc!shared/components/codemirror","data","vendor/ractive-transitions-slide/ractive-transitions-slide","vendor/ractive-transitions-fly/ractive-transitions-fly"],function(require,Ractive,_import_0){
  var __options__={
